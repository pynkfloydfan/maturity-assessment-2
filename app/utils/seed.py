...
def seed_database_from_excel(cfg: DBConfig, excel_path: Path) -> tuple[int, str, str, str]:
    ...
    if cfg.backend == "sqlite":
        ...
        cmd += [
            "--mysql-host", cfg.mysql_host or "localhost",
            "--mysql-port", str(cfg.mysql_port or 3306),
            "--mysql-user", cfg.mysql_user or "root",
            "--mysql-password", cfg.mysql_password or "",
            "--mysql-db", cfg.mysql_db or "resilience",
        ]
