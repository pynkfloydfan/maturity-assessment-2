...
def cached_topics_df(_session_factory: sessionmaker[Session], db_url: str) -> pd.DataFrame:
...
def cached_explanations_for(
    _session_factory: sessionmaker[Session], db_url: str, topic_ids: tuple[int, ...]
