...
def upgrade() -> None:
    ...
    op.create_table('assessment_entries',
        sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index('ix_assessment_entries_session_id', 'assessment_entries', ['session_id'], unique=False)
    op.create_index('ix_assessment_entries_topic_id', 'assessment_entries', ['topic_id'], unique=False)
